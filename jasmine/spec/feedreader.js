...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         it('should have each feed url defined and not empty', function () {
         ...
         */
         it('should have each feed name defined and not empty', function () {
            for(var i=0, len=allFeeds.length; i<len; i++){
    ...
    /* A new test suite named "The menu" */
        ...
        it('should show menu on clicking the menu icon link and hide the menu on clicking it again', function () {
            MENU_BUTTON.click();
    ...
    /* A new test suite named "Initial Entries" */
         ...
         * element within the .feed container(loadFeed() is asynchronous).So for this 
         * test I have used Jasmine's beforeEach and asynchronous done() function.
         */
        ...
        it('should loadFeed and render the entry within .feed container', function () {
    ...
    /* A new test suite named "New Feed Selection" */
         ...
         * function that the content actually changes(loadFeed() is asynchronous).
         */
